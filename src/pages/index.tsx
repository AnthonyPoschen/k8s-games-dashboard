...
<>
  ...
  <main className="flex min-h-screen flex-col items-center bg-gray-800 from-[#2e026d] to-[#15162c] text-slate-200">
    ...
    <div className="flex flex-wrap w-full h-full p-8 lg:p-2 lg:w-1/2 justify-center">
      {servers.data?.map((el) =>
      <div className="w-full flex flex-grow p-2 even:bg-gray-500 odd:bg-gray-600">
        <h2 className="w-[250px] font-bold text-xl">
        ...
        <button className="w-[150px] border-slate-500 bg-red-700 hover:bg-red-600 rounded" type="button" onClick={()=>
          ChangeServerState(el)}>Turn Off</button>
        :
        <button className="w-[150px] border-slate-500 bg-green-700 hover:bg-green-600 rounded" type="button"
          onClick={()=>
